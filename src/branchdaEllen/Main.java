        ...
        do{
            ...
            if(opcao==1){
				...
				if(robo1.encontrarAlimento(comida)==true){
                	robo1.setPontuacao(1);
                }
                else {
                	robo2.setPontuacao(1);
                }
				System.out.println("Robô encontrou a comida!");
                ...
                if(robos[0].encontrarAlimento(comida)==true){
                	robos[0].setPontuacao(1);
                }
                else {
                	robos[1].setPontuacao(1);
                }
                System.out.println("Robô encontrou a comida!");
                System.out.println("---Robô 1---");
                System.out.println("Pontuação Jogador: "+robos[0].getPontuacao());
                ...
                System.out.println("---Robô 2---");
				System.out.println("Pontuação Jogador: "+robos[1].getPontuacao());
